...
const typeNum = (arr) => {
  // Solution code here...
  let newArray=arr.filter(val=>!isNaN(val));
  return newArray;
};
...
const containsAnd = (arr) => {
  let newArray=arr.filter(val=>val.includes('and'));
  return newArray;
  // Solution code here...
};
...
const oddValues = (arr) => {
  // Solution code here...
  let newArray=arr.filter(val=>val%2===1);
  return newArray;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let newArray = arr.filter(val => !(forbiddenValues.includes(val)));
  return newArray;
};
